...
The credibility graph is made up of two types of nodes: sources and claims. The assertions link these node types to form a bipartite graph where sources can only connect with claims and claims can only connect with sources. Figure~\ref{fig:credibility-graph} pictures a simplified example of the graph.
